...
[shopinvader](shopinvader/) | 14.0.5.24.13 |  | Shopinvader
...
[shopinvader_auth_api_key](shopinvader_auth_api_key/) | 14.0.1.1.2 |  | Shopinvader API_KEY Authentication
...
[shopinvader_image](shopinvader_image/) | 14.0.1.3.1 |  | Add the export of Image for Shopinvader
...
[shopinvader_product_manufactured_for](shopinvader_product_manufactured_for/) | 14.0.1.1.0 |  | Manage Product Made Specially For Some Customers
...
[shopinvader_validation_token_guest](shopinvader_validation_token_guest/) | 14.0.1.0.1 |  | Apply the security token notification on guest mode too
