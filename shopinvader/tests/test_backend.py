...
class BackendCase(CommonCase):
    ...
    def test_bind_all_product(self):
        self.assertEqual(self._all_products_count(), self._all_products_binding_count())
    ...
    def _setup_bind_all_products(self):
        ...
        prod1 = self.env.ref("shopinvader.product_template_armchair_mid_century")
        prod2 = self.env.ref("shopinvader.product_product_table_walmut").product_tmpl_id
        ...
        categ_lvl1 = categ_model.create({"name": "Level 1", "parent_id": categ_lvl0.id})
        categ_lvl2 = categ_model.create({"name": "Level 2", "parent_id": categ_lvl1.id})
        categ_lvl3 = categ_model.create({"name": "Level 3", "parent_id": categ_lvl2.id})
        categ_lvl4 = categ_model.create({"name": "Level 4", "parent_id": categ_lvl3.id})
