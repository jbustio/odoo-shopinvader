...
class TestShopinvaderCategory(ProductCommonCase):
    ...
    def test_real_level1(self):
        ...
        self.assertEquals("0.0", shop_categ.real_level)
        shop_categ.sequence = 17
        self.assertEquals("0.17", shop_categ.real_level)
    ...
    def test_real_level2(self):
        ...
        self.assertEquals("1.10.20", shop_categ.real_level)
        shop_categ.sequence = 30
        self.assertEquals("1.10.30", shop_categ.real_level)
