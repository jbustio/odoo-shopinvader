...
@wishlist_router.post("/wishlists/{_id}/update", status_code=205)
@wishlist_router.put("/wishlists/{_id}", status_code=205)
def update(
    wishlist_router_helper: Annotated[
        ShopinvaderApiWishlistRouterHelper, Depends(wishlist_router_helper)
    ],
...
@wishlist_router.post("/wishlists/{_id}/add_item", status_code=205)
def add_item(
    wishlist_router_helper: Annotated[
        ShopinvaderApiWishlistRouterHelper, Depends(wishlist_router_helper)
    ],
...
@wishlist_router.post("/wishlists/{_id}/add_items", status_code=205)
def add_items(
    wishlist_router_helper: Annotated[
        ShopinvaderApiWishlistRouterHelper, Depends(wishlist_router_helper)
    ],
...
@wishlist_router.post("/wishlists/{_id}/update_item", status_code=205)
def update_item(
    wishlist_router_helper: Annotated[
        ShopinvaderApiWishlistRouterHelper, Depends(wishlist_router_helper)
    ],
...
@wishlist_router.post("/wishlists/{_id}/update_items", status_code=205)
def update_items(
    wishlist_router_helper: Annotated[
        ShopinvaderApiWishlistRouterHelper, Depends(wishlist_router_helper)
    ],
...
@wishlist_router.post("/wishlists/{_id}/delete_item", status_code=205)
def delete_item(
    wishlist_router_helper: Annotated[
        ShopinvaderApiWishlistRouterHelper, Depends(wishlist_router_helper)
    ],
...
@wishlist_router.post("/wishlists/{_id}/delete_items", status_code=205)
def delete_items(
    wishlist_router_helper: Annotated[
        ShopinvaderApiWishlistRouterHelper, Depends(wishlist_router_helper)
    ],
...
@wishlist_router.post("/wishlists/{_id}/move_item", status_code=205)
def move_item(
    wishlist_router_helper: Annotated[
        ShopinvaderApiWishlistRouterHelper, Depends(wishlist_router_helper)
    ],
...
@wishlist_router.post("/wishlists/{_id}/move_items", status_code=205)
def move_items(
    wishlist_router_helper: Annotated[
        ShopinvaderApiWishlistRouterHelper, Depends(wishlist_router_helper)
    ],
...
@wishlist_router.post("/wishlists/{_id}/replace_item/", status_code=205)
def replace_item(
    wishlist_router_helper: Annotated[
        ShopinvaderApiWishlistRouterHelper, Depends(wishlist_router_helper)
    ],
...
@wishlist_router.post("/wishlists/{_id}/replace_items/", status_code=205)
def replace_items(
    wishlist_router_helper: Annotated[
        ShopinvaderApiWishlistRouterHelper, Depends(wishlist_router_helper)
    ],
