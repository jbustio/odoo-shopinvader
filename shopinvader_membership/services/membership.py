...
class MembershipService(Component):
    ...
    def _get_selection_label(self, membership_line, field):
        ...
        :param membership_line: memberhsip.membership_line recordset
        :param field: str
        :return: str
        """
        ...
        type_dict = dict(
            membership_line._fields.get(
                field
            )._description_selection(
                membership_line.env
            )
        )
        technical_value = membership_line[field]
    ...
    def _to_json_membership_line(self, membership_line):
        ...
        values.update(
            {
                "state": self._get_selection_label(membership_line, "state"),
            }
        )
        return values
