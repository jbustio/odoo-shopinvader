...
# FIXME: not working if get method. But it should
@delivery_carrier_router.post("/delivery_carriers")
def search(
    env: Annotated[api.Environment, Depends(authenticated_partner_env)],
    partner: Annotated["ResPartner", Depends(authenticated_partner)],
    data: DeliveryCarrierSearch,
...
# FIXME: not working if get method. But it should
@delivery_carrier_router.post("/{uuid}/delivery_carriers")
@delivery_carrier_router.post("/current/delivery_carriers")
def search_current(
    env: Annotated[api.Environment, Depends(authenticated_partner_env)],
    partner: Annotated["ResPartner", Depends(authenticated_partner)],
    data: DeliveryCarrierSearch,
