...
class TestDeliveryService(CommonCase):
    ...
    def test_get_picking_logged_without_sale(self):
        ...
        picking = self._create_picking(partner=self.service.partner)
    ...
    def test_get_multi_picking(self):
        ...
        :return:
        """
        picking1 = self._create_picking(partner=self.service.partner)
        picking2 = self._create_picking(partner=self.service.partner)
